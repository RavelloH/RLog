...
(rlog.config.timeFormat = "UTC"), rlog.info("UTC");
(rlog.config.timeFormat = "timestamp"), rlog.info("timestamp");
(rlog.config.timeFormat = "ISO"), rlog.info("ISO");
...
rlog.success("Hello world!", "This is a message", 123, true);
